...
function normalizeStatus(s?: string): keyof typeof STATUS_COLORS {
  ...
  const map: Record<string, keyof typeof STATUS_COLORS> = {
    ...
    'PENURUNAN_SATURASI_OKSIGEN': 'Penurunan Saturasi Oksigen',
    'Penurunan Saturasi Oksigen': 'Penurunan Saturasi Oksigen',
    'HIPOKSEMIA_RINGAN': 'Penurunan Saturasi Oksigen',
    ...
    'WASPADA': 'Perlu Pemeriksaan',
    'Waspada': 'Perlu Pemeriksaan',
    'DARURAT': 'Perlu Pemeriksaan',
    'Darurat': 'Perlu Pemeriksaan',
  };
  return map[s] || 'Normal';
}
